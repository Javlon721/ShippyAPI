...
x1, y1, azimuth1 = 8, 13, 32
x2, y2, azimuth2 = -8, -5, 263
ship_1.set_coords(x1, y1)
ship_1.set_azimuth(azimuth1)

ship_2.set_coords(x2, y2)
ship_2.set_azimuth(azimuth2)

Ship.print_ships(ship_1, ship_2)
ship_1.change_coords()
print('-' * 30)
Ship.print_ships(ship_1, ship_2)
